...
func (m *MockUserRedisRepository) GetByIDCtx(ctx context.Context, key string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRedisRepository) SetUserCtx(ctx context.Context, key string, seconds int, user *entity.User) error {
	m.ctrl.T.Helper()
